...
import com.adjecti.meeting.exception.NoSuchEmployeeException;
import com.adjecti.meeting.model.Employee;
import com.adjecti.meeting.model.impl.EmployeeImpl;
import com.adjecti.meeting.model.impl.EmployeeModelImpl;
...
public class EmployeePersistenceImpl
	...
	/**
	 * Returns all the employees where phoneNo = &#63;.
	 *
	...
	/**
	 * Returns a range of all the employees where phoneNo = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EmployeeModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Employee> findByphoneNo(String phoneNo, int start, int end) {
		return findByphoneNo(phoneNo, start, end, null);
	}

	/**
	 * Returns an ordered range of all the employees where phoneNo = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EmployeeModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Employee> findByphoneNo(
	...
	public List<Employee> findByphoneNo(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Employee employee : list) {
					if (!phoneNo.equals(employee.getPhoneNo())) {
						list = null;
	...
	/**
	 * Returns the first employee in the ordered set where phoneNo = &#63;.
	 *
	 * @param phoneNo the phone no
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching employee
	 ...
	 */
	@Override
	public Employee findByphoneNo_First(
			String phoneNo, OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByphoneNo_First(phoneNo, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchByphoneNo_First(
		String phoneNo, OrderByComparator<Employee> orderByComparator) {

		List<Employee> list = findByphoneNo(phoneNo, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last employee in the ordered set where phoneNo = &#63;.
	 *
	 * @param phoneNo the phone no
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching employee
	 ...
	 */
	@Override
	public Employee findByphoneNo_Last(
			String phoneNo, OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByphoneNo_Last(phoneNo, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchByphoneNo_Last(
		String phoneNo, OrderByComparator<Employee> orderByComparator) {
		...
		List<Employee> list = findByphoneNo(
	...
	/**
	 * Returns the employees before and after the current employee in the ordered set where phoneNo = &#63;.
	 *
	 * @param employeeId the primary key of the current employee
	 * @param phoneNo the phone no
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Employee[] findByphoneNo_PrevAndNext(
			long employeeId, String phoneNo,
			OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {
		...
		try {
			...
			array[0] = getByphoneNo_PrevAndNext(
				session, employee, phoneNo, orderByComparator, true);

			array[1] = employee;

			array[2] = getByphoneNo_PrevAndNext(
				session, employee, phoneNo, orderByComparator, false);
	...
	protected Employee getByphoneNo_PrevAndNext(
		Session session, Employee employee, String phoneNo,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the employees where phoneNo = &#63; from the database.
	 *
	 * @param phoneNo the phone no
	 */
	@Override
	...
	/**
	 * Returns the number of employees where phoneNo = &#63;.
	 *
	 * @param phoneNo the phone no
	 * @return the number of matching employees
	 */
	...
	private static final String _FINDER_COLUMN_PHONENO_PHONENO_3 =
		"(employee.phoneNo IS NULL OR employee.phoneNo = '')";
